  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-almond to-blanc flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-serif text-lex-brown mb-4">Something didn't load properly</h1>
        <p className="text-lex-brown mb-8 opacity-75">
          We encountered an issue loading this page. Please try refreshing or return to the homepage.
        </p>
