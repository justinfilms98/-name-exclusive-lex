    ...
    <ClientErrorBoundary>
      <div className="min-h-screen bg-almond">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 max-[430px]:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:justify-items-center md:justify-center gap-3 sm:gap-4 md:gap-6">
            {albums.map((album) => {
