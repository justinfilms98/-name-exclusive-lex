-- Fix Supabase Storage Policies - WORKS WITH SUPABASE PERMISSIONS
-- This script creates storage policies using Supabase's built-in functions
...
-- Step 3: Create policy to allow access ONLY to purchased media files
